...
% * Couverture de thèse
\includepdf{1_FrontMatter/1_Couverture_de_these}                % Fichier PDF à remplacer par votre page générée via ADUM
    \cleardoublepage%

% * Seconde de couverture
\include{1_FrontMatter/2_Seconde_de_couverture}
    \cleardoublepage%

% * Remerciements
\include{1_FrontMatter/3_Remerciements}
    \cleardoublepage%
...
% * Nomenclature
\include{1_FrontMatter/4_Nomenclature}
    \cleardoublepage%
