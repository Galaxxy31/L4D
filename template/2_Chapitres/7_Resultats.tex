...
\graphicspath{{5_Images/7_Resultats/}}                          % Chemin vers le stockage des images du chapitre
\makeatletter
\def\input@path{{5_Images/7_Resultats/}}                        % Pareil que au dessus
\makeatother
...
\chapter{Resultats}\label{chap:Resultats}                       % Ajout d'un nouveau chapitre
