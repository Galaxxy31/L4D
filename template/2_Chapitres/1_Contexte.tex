...
\graphicspath{{5_Images/1_Contexte/}}                           % Chemin vers le stockage des images du chapitre
\makeatletter
\def\input@path{{5_Images/1_Contexte/}}                         % Pareil que au dessus
\makeatother

% !===========================================================

\chapter{Contexte}\label{chap:Contexte}                         % Ajout d'un nouveau chapitre
