...
\graphicspath{{5_Images/4_Physique/}}                           % Chemin vers le stockage des images du chapitre
\makeatletter
\def\input@path{{5_Images/4_Physique/}}                         % Pareil que au dessus
\makeatother
...
\chapter{Physique}\label{chap:Physique}                         % Ajout d'un nouveau chapitre
