...
\graphicspath{{5_Images/3_Problematique/}}                      % Chemin vers le stockage des images du chapitre
\makeatletter
\def\input@path{{5_Images/3_Problematique/}}                    % Pareil que au dessus
\makeatother

% !===========================================================

\chapter{Problematique}\label{chap:Problematique}               % Ajout d'un nouveau chapitre
