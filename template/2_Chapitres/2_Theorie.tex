...
\graphicspath{{5_Images/1_Theorie/}}                            % Chemin vers le stockage des images du chapitre
\makeatletter
\def\input@path{{5_Images/1_Theorie/}}                          % Pareil que au dessus
\makeatother

% !===========================================================

\chapter{Theorie}\label{chap:Theorie}                           % Ajout d'un nouveau chapitre
