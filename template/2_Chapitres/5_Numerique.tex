...
\graphicspath{{5_Images/5_Numerique/}}                          % Chemin vers le stockage des images du chapitre
\makeatletter
\def\input@path{{5_Images/5_Numerique/}}                        % Pareil que au dessus
\makeatother
...
\chapter{Numerique}\label{chap:Numerique}                       % Ajout d'un nouveau chapitre
