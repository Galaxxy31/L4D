...
\graphicspath{{5_Images/6_Experimentale/}}                      % Chemin vers le stockage des images du chapitre
\makeatletter
\def\input@path{{5_Images/6_Experimentale/}}                    % Pareil que au dessus
\makeatother

% !===========================================================

\chapter{Experimentale}\label{chap:Experimentale}               % Ajout d'un nouveau chapitre
